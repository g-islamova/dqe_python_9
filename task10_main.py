...
from task10_imp_module import capitalize_first_word, normalize_text
...
def main():
    ...
    database_manager = DatabaseManager('DRIVER={SQLite3 ODBC Driver};'
                                       'SERVER=localhost;'
        ...
        try:
            ...
            if choice == 1:
                ...
                if success:
                    ...
                    print("Records added from txt file successfully.")
                    for record in news_feed.records:
                        database_manager.save_record(record)
                        print("Records added from txt file to database successfully.")
                else:
                ...
                if data:
                    ...
                    if success:
                        ...
                        for record in news_feed.records:
                            database_manager.save_record(record)
                        print("Records added from JSON file to database successfully.")
                ...
                if data:
                    ...
                    if success:
                        ...
                        for record in news_feed.records:
                            database_manager.save_record(record)
                        print("Records added from XML file to database successfully.")
                        for file_name in os.listdir(folder_path):
